...
from yolo_fnr import (finn_yolo_bokser, snill_sjekk, tokens_i_boks,
                      overlapp_andel_boks, YOLO_CONF_UTEN_TEKST,
                      er_vertikal, YOLO_CONF_VERTIKAL)

DEDUP_OVERLAPP = 0.5     # YOLO-boks regnes som "samme" naar den dekker Paddle-boks saa mye
